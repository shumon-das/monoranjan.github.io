              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="ad-vendors/images/img.jpg" alt=""><?php echo $admin['username']; ?>
                  </a>
                ...
                <li role="presentation" class="nav-item dropdown open">
                  ...
                  <ul class="dropdown-menu list-unstyled msg_list" style="display: none;" role="menu" aria-labelledby="navbarDropdown1">
                    <li class="nav-item">
...
while($r = mysqli_fetch_assoc($t)){?>
                        <tr>
                          ...
                          <td><?php echo $r['exchange_id']; ?></td>
                          <td><?php echo $r['phone']; ?></td>
                          <td><span class="btn btn-round"><?php echo $r['order_type']; ?></span></td>
                          <?php if($r['status'] == 'completed'){ ?>
                          <td><a class="btn btn-success btn-sm dan" href="details.php?d=<?php echo $r['exchange_id']; ?>"><i class="fa fa-check-square"></i><?php echo "Complete" ?></a></td>
                        <?php }elseif($r['status'] == 'waiting'){?>
                          <td><a class="btn btn-dark btn-sm dan" href="details.php?d=<?php echo $r['exchange_id']; ?>"><i class="fa fa-spinner"></i> <?php echo $r['status']; ?></a></td>
                        <?php }else{?>
                          <td class=""> <a class="btn btn-danger btn-sm dan" href="details.php?d=<?php echo $r['exchange_id']; ?>"> <i class="fa fa-close"></i> <?php echo $r['status']; ?></a></td>
                        <?php }?>
