              ...
              <div class="col-sm-8">
                <div class="panel widget">
                  ...
                  <div id="wizard-1" class="panel-body vd_custom-product form-wizard">
                    <form class="form-horizontal" action="functions.php" method="post" role="form" id="register-form">
                            ...
                            <div class="menu-text" style="margin-left: 0px;">
                              ...
                              <div class="radio" style="width: 50%;float: left;">
                               <i>send to </i> <label style="width: 100%;padding-left:0;"> 
                                 <?php 
                                   $icon_query = mysqli_query($conn,"SELECT * FROM ba ORDER BY id DESC LIMIT 1");
                                   $icon = mysqli_fetch_assoc($icon_query);
                                   $bdico = $icon['account_name'];
                                  ?>
                                  <img src="http://localhost/project_one/img/<?php echo $icon['account_logo']; ?>" alt="" style="width:50px;margin-top: 15px;float: left;height: 50px;" id="blogo">
                                  <select name="send_from" id="send_method" style="width: 80%;float:left;height: 50px;margin-top: 15px;">
                              <?php 
                                  $bd_sql = mysqli_query($conn,"SELECT * FROM `ba`");
                                  while ($brows = mysqli_fetch_assoc($bd_sql)) {
                                          echo "<option value='".$brows['account_name']."'>".$brows['account_name']."</option>";
                                        }
                              ?>                
                                  </select>
                             ...
                             <?php 
                              ...
                              <div class="radio" style="width: 50%;float: left;">
                                <label style="width: 100%;padding-left:0;"> 
                                 <?php 
                                   $re_sql = mysqli_query($conn,"SELECT * FROM trs_rate WHERE send_name='$bdico' AND receive_name='$ico'");
                              ...
                              <div class="radio" style="width: 50%;float: left;">
                                <label style="width: 100%;padding-left:0;"> 
                                  ...
                                  <input type="text" name="receive_amount" id="receive_input" disabled="" style="width:96%;float:left;height: 50px;margin-top: 15px;font-family: sans-serif;font-size: 18px;"value="0">
                                  <input type="hidden" name="receive_amount" value="" id="dreceive_input">
                              </div>
                            
                             <input type="text" disabled="" value=" Exchange rate <?php echo $send_rate .' BDT to '.$res['receive_rate']. ' USD '.'    '. ' '.' Reserved '.$res['reserve'];  ?> USD" id="show_rate_input">
                        ...
                        <div id="tab2" class="tab-pane">
                          <div class="form-group content-list">
                            <div class="menu-text" style="margin-left: 0px;">
                              ...
                              <label for=""><span id="mail"></span> Account NO</label>
                              <input type="text" name="trs_mail" id="trs_mail">
                            ...
                            <div class="menu-text" style="margin-left: 0px;">
                              ...
                              <div class="panel widget light-widget panel-bd-left">
                                <table class="table table-condensed table-striped">
                                  ...
                                  <tr>
                                    <td>Receive with</td>
                                    <td id="dreceive_method">skrill</td>
                                  ...
                                  <tr>
                                    ...
                                    <td id="invoice_email_address">
                                      <label class='alert alert-danger msgall'>please give the account number</label>
                                    </td>
                                  </tr>
                      ...
                      <input type="hidden"  name="order_type" value="by">
                      <!-- tab-content -->
     ...
     // alert(bsm + brm);
      $.ajax({
        ...
        success:function(data){
          $("#blogo").attr('src','http://localhost/project_one/img/'+data.blogo);
  ...
  $(document).ready(function(){
   ...
   $(document).ready(function(){
    $("#given_input").keyup(function(){ 
      $(".msgall").hide();
      var bsend = $("#send_method").val();
      var breceive = $("#receive_method").val();
      var bgi = $("#given_input").val();
       $.ajax({
        url:"functions.php",
        type:"post",
        dataType:"json",
