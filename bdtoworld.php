                	...
                	<h3 id="inq_success" class="alert alert-info" style="display: none;"></h3>
                        <form action="functions.php" method="post">
                          <div class="form-group content-list">
                            ...
                            <div class="row">
                              <div class="col">
                                <i>send to </i> <label style="width: 100%;padding-left:0;"> 
                                  ...
                                  <img src="http://localhost/project_one/img/rocket.jpg" alt="" style="width:50px;margin-bottom: 15px;float: left;height: 50px;" id="wa_logo">
                                  <select name="send_name" id="send_name" style="width: 80%;float:left;height: 50px;margin-bottom: 15px;">
                                <?php
                                    $ba_sql = mysqli_query($conn,"SELECT * FROM `ba`");
                                    while ($barows = mysqli_fetch_assoc($ba_sql)) {
                                      echo "<option value='".$barows['account_name']."'>".$barows['account_name']."</option>";
                                          }                                     
                                ?>                
                                  </select>  
                              </div>
                              <div class="col">
                                <i style="margin-left: 20px;">receive with </i><label style="width: 100%;padding-left:0;"> 
                                  <img src="http://localhost/project_one/img/skrill.jpg" alt="" style="width:50px;margin-bottom: 15px;float: left;height: 50px;" id="logo">
                                  <select name="receive_name" id="receive_name" style="width: 80%;float:left;height: 50px;margin-bottom: 15px;">
                                <?php 
                              ...
                              <input type="number" name="send_rate" id="send_rate" value="100" style="width: 96%;float:left;height: 50px;margin-bottom: 15px;font-family: sans-serif;font-size: 18px;"> 
                              </div>
                              <div class="col">
                                <label style="width: 100%;padding-left:0;">Receive rate</label> 
                                  <input type="text" name="receive_rate" id="receive_rate"  value=""  placeholder="0.90 USD" style="width: 96%;float:left;height: 50px;margin-bottom: 15px;font-family: sans-serif;font-size: 18px;">
                            ...
                            <div class="row">
                              <div class="col">
                                <?php $skrill_reserve = mysqli_query($conn,"SELECT * FROM trs_rate WHERE receive_name='skrill'");$srows = mysqli_fetch_assoc($skrill_reserve); ?>
     ...
     // alert(bsm + brm);
      $.ajax({
        ...
        success:function(data){
          $("#wa_logo").attr('src','http://localhost/project_one/img/'+data.blogo);
  ...
  $(document).ready(function(){
    $("#receive_name").change(function(){
      ...
      $.ajax({
        ...
        success:function(data){
           $("#logo").attr('src','http://localhost/project_one/img/'+data.wa_logo);
