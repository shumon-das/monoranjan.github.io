...
if(isset($_COOKIE['email']) && isset($_COOKIE['password'])){
  ...
  if(mysqli_num_rows($login_sql) == 1){
    $fetch_rows = mysqli_fetch_assoc($login_sql);
    $_SESSION['user_id'] = $fetch_rows['id'];
...
<head>
    ...
    <meta name="keywords" content="HTML5 Template, CSS3, All Purpose Admin Template, Exchange" />
                  ...
                  <div class="alert alert-success vd_hidden">
                    ...
                    <div class="form-group">
                      <div class="col-md-12 text-center mgbt-xs-5">
                        <input class="btn vd_bg-green vd_white width-100" name="submit" type="submit" value="Login">
                      </div>
