                  ...
                  <h3 id="inq_success" class="alert alert-info" style="display: none;"></h3>
                        <form action="functions.php" method="post">
                          <div class="form-group content-list">
                            <div class="row">
                              <div class="col">
                                <i>send to </i> <label style="width: 100%;padding-left:0;"> 
                                  ...
                                  <img src="http://localhost/project_one/img/bitcoin.png" alt="" style="width:50px;margin-bottom: 15px;float: left;height: 50px;" id="wa_logo">
                              ...
                              <div class="col">
                                <i style="margin-left: 20px;">receive with </i><label style="width: 100%;padding-left:0;"> 
                                  <img src="http://localhost/project_one/img/rocket.jpg" alt="" style="width:50px;margin-bottom: 15px;float: left;height: 50px;" id="logo">
                                  <select name="receive_name" id="receive_name" style="width: 80%;float:left;height: 50px;margin-bottom: 15px;">
                                <?php 
                                  $b_sql = mysqli_query($conn,"SELECT * FROM `ba`");
                                  while ($brows = mysqli_fetch_assoc($b_sql)) {
                            ...
                            <div class="row">
                                <div class="col">
                                  <?php $rocket_reserve = mysqli_query($conn,"SELECT * FROM trs_rate WHERE receive_name='rocket'");$srows = mysqli_fetch_assoc($rocket_reserve); ?>
